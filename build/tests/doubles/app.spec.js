...
const fake_warning_repo_1 = require("../../src/doubles/fake-warning-repo");
let app;
var clock = sinon_1.default.useFakeTimers(new Date("2024-01-03"));
describe("app using fake repositories", () => {
    beforeEach(() => {
        app = new app_1.App(new fake_businessPartner_repo_1.FakeBusinessPartnerRepo(), new fake_employee_repo_1.FakeEmployeeRepo(), new fake_equipment_repo_1.FakeEquipmentRepo(), new fake_feeding_repo_1.FakeFeedingRepo(), new fake_food_repo_1.FakeFoodRepo(), new fake_maintenance_repo_1.FakeMaintenanceRepo(), new fake_tank_repo_1.FakeTankRepo(), new fake_tankVerification_repo_1.FakeTankVerificationRepo(), new fake_transaction_repo_1.FakeTransactionRepo(), new fake_treatment_repo_1.FakeTreatmentRepo(), new fake_medication_repo_1.FakeMedicationRepo(), new fake_warning_repo_1.FakeWarningRepo(), new fake_fishSpecie_repo_1.FakeFishSpecieRepo());
        clock.restore();
    });
    ...
    describe("register tank", () => {
        ...
        const tank = new tank_1.Tank(specie, "L-B2", "room 6", 98, 2000);
        const tank1 = new tank_1.Tank(specie, "L-B2", "room 7", 70, 2500);
        const tank2 = new tank_1.Tank(specie, "S-C2", "room 7", 91, 100);
        const tank3 = new tank_1.Tank(specie, "M-A1", "room 1", 91, 3000);
        const tank4 = new tank_1.Tank(specie, "S-C2", "room 9", 37, 3000);
        const tank5 = new tank_1.Tank(specie, "S-C2", "room 9", -9, 3000);
        const tank6 = new tank_1.Tank(specie, "S-C2", "room 9", 90, -2000);
    ...
    describe("register feeding", () => {
        const specie = new fishSpecie_1.FishSpecie("tilapia", "flakes", { min: 16.5, max: 30 }, { min: 10, max: 15 }, { min: 5, max: 8 });
        const tank = new tank_1.Tank(specie, "M-C2", "room 3", 34.5, 1200);
        const employee = new employee_1.Employee("david", "david@mail.com", "president", "123");
        const partner = new businessPartner_1.BusinessPartner(987, "company@mail.com", "company llc", "street 6, 223");
        const food = new food_1.Food("flakes", 200, 999.35, new Date("2027-07-16"), partner);
    ...
    describe("register medication", () => {
        ...
        const employee = new employee_1.Employee("david", "david@mail.com", "president", "123");
        const partner = new businessPartner_1.BusinessPartner(987, "company@mail.com", "company llc", "street 6, 223");
        const treatment = new treatment_1.Treatment("skin med", 300, 15200.9, new Date("2024-10-10"), partner);
        ...
        it("throws InsuficientTreatmentError when trying to register a medication with a quantity greater than storage", async () => {
            ...
            await app.registerBusinessPartner(partner);
            const treatmentId = await app.registerTreatment(treatment);
            await expect(app.registerMedication(tankId, employee.email, treatmentId, 300)).rejects.toThrow(insuficient_treatment_error_1.InsuficientTreatmentError);
        });
    ...
    describe("retrieves a list of verifications by some employee property", () => {
        ...
        const specie = new fishSpecie_1.FishSpecie("tilapia", "flakes", { min: 16.5, max: 30 }, { min: 10, max: 15 }, { min: 5, max: 8 });
        const tank = new tank_1.Tank(specie, "L-A1", "room 2", 76, 2300);
    ...
    describe("retrieves a list of feedings by some employee property", () => {
        ...
        const food = new food_1.Food("flakes", 200, 1000.99, new Date("2024-10-10"), seller);
    ...
    describe("retrieves a list of purchases by some employee property", () => {
        ...
        const partner = new businessPartner_1.BusinessPartner(987, "company@mail.com", "company llc", "street 4, 873");
        const equipment = new equipment_1.Equipment("hammer", "new", "tools room", partner, 0, 14.2, 2);
        new equipment_1.Equipment("hammer", "new", "tools room", partner, 0, 14.2, -22);
        const food = new food_1.Food("flakes", 300, 2998.65, new Date("2024-1010"), partner);
        new food_1.Food("flakes", -20, 2998.65, new Date("2024-1010"), partner);
        const treatment = new treatment_1.Treatment("skin med", 100, 3499.75, new Date("2025-1010"), partner);
        new treatment_1.Treatment("skin med", -45, 3499.75, new Date("2025-1010"), partner);
        ...
        it("throws UnableToFindError when trying to search by a non-existent employee property or that search is empty", async () => {
            ...
            const foodId = await app.registerFood(food);
            const treatmentId = await app.registerTreatment(treatment);
            await app.registerPurchase(6498.4, partner.ein, foodId, treatmentId, employeeId, employee.email);
    ...
    describe("retrieves a list of medications by some employee property", () => {
        ...
        const tank = new tank_1.Tank(specie, "L-A1", "room 2", 76, 2300);
        const seller = new businessPartner_1.BusinessPartner(987, "company@mail.com", "company llc", "street 4, 873");
        const treatment = new treatment_1.Treatment("skin med", 300, 9800.9, new Date("2024-10-10"), seller);
    ...
    describe("retrieves a list of maintenances by some employee property", () => {
        ...
        const employee2 = new employee_1.Employee("aaron", "aaron@mail.com", "president", "123");
        const seller = new businessPartner_1.BusinessPartner(987, "company@mail.com", "company llc", "street 4, 873");
        const equipment = new equipment_1.Equipment("oxygen bomb", "ok", "room 4", seller, 0, 14000, 1);
        const equipment2 = new equipment_1.Equipment("oxygen bomb", "ok", "room 5", seller, 0, 14500, 1);
    ...
    describe("filter transactions", () => {
        ...
        const food = new food_1.Food("flakes", 200, 100, new Date("2025-11-11"), partner);
        const treatment = new treatment_1.Treatment("skin med", 40, 100, new Date("2025-11-11"), partner);
        const equipment = new equipment_1.Equipment("computer", "new", "office 1", partner, 0, 100, 1);
