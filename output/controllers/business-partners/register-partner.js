...
function registerPartnerController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, app_factory_1.default.registerBusinessPartner(req.body)];
                case 1:
                    id = _a.sent();
                ...
                case 2:
                    e_1 = _a.sent();
                    if (e_1 instanceof duplicate_partner_error_1.DuplicatePartnerError) {
                        res.status(400).json({
                            message: e_1.message,
                        });
                        return [2 /*return*/];
