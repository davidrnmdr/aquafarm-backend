...
var fishSpecie_1 = require("../../entities/fishSpecie");
var crypto = require("crypto");
var models_1 = require("./models");
var SequelizeFishSpecieRepo = /** @class */ (function () {
    function SequelizeFishSpecieRepo() {
    }
    SequelizeFishSpecieRepo.prototype.add = function (specie) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, models_1.FishSpecies.create({
    ...
    SequelizeFishSpecieRepo.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    return SequelizeFishSpecieRepo;
}());
